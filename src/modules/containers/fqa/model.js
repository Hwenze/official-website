...
export const fqaList = [
    ...
    { img: two, title: 'Q.Which plan is the most suitable one for me?', text: "That is entirely dependent on the releases you are targeting and the amount of profiles and tasks you use. Remember, all Brick proxy are private and dedicated to the user, each proxy is recommended to be used for up to 3 tasks on the same site or site group such as footsites." },
    { img: three, title: 'Q.How can I test my Brick proxy?', text: 'Running a test task is the best way to test the proxies. To check the proxies if they ping.' },
    ...
    { img: eight, title: 'Q.8.What are the retailers Brick proxy works best?', text: "Brick proxy works across all over the world based retailers' sites. There isn't any single retailer where Brick proxy are blocked." },
    { img: nine, title: 'Q.Will the money in the Brick Top-Up dashboard expire?', text: 'NO' },
    ...
    { img: twelve, title: 'Q.Why has my data been depleted?', text: 'When you start any task(s) with Brick proxy, it’ll use up data. some bots will still run even when you close it so make sure to stop the tasks first before you turn off your bots.' },
];
